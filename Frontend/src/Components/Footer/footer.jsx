    ...
    return (
        <footer className="bg-black text-white">
            <div className="flex p-5 justify-between">
                <div className="flex flex-1 flex-col text-center sm:flex-row items-center justify-center space-x-3">
                    <div>
                        <img
                    ...
                    <div>
                        <div className="space-y-2">
                            <h3 className="text-2xl">Adopt a pet</h3>
                ...
                {/* Subscribe column */}
                <div className="md:flex flex-col hidden text-center items-center flex-1">
                    <div className="space-y-2">
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="flex mt-2 flex-row space-x-3 my-0">
                        ...
                        <div>
                            <a href="#" className="w-10 ml-3 mr-3">
                                {/* Instagram icon */}
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="40"
            ...
            <div className="bg-gray-900 pt-5 pb-8 flex flex-col text-center md:hidden mt-8 items-center flex-1">
                <div className="space-y-2">
