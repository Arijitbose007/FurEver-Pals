    ...
    return (
        <section className="dark:bg-gray-900 b_1 pt-20 pb-20">
            <div className="w-full contact-form-container mx-auto max-w-screen-md">
                ...
                >
                    <p id="contact"></p>
                    <h2 className="text-3xl mt-1 mb-2 text-center bold-500 text_3">
                        CONTACT US
                    </h2>
                    <p className="text-base text-center text_3">
                        Any issues! Fill the form below and our team will contact you shortly.
                    </p>
                    <br />
                    <div className="mb-4">
                        <label className="block text-white text-sm font-bold mb-2" htmlFor="contact_nom">
                            Name
                        </label>
                        <input
                    ...
                    <div className="mb-6">
                        <label className="block text-white text-sm font-bold mb-2" htmlFor="contact_message">
                            Message
                        </label>
                        <textarea
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-outline"
